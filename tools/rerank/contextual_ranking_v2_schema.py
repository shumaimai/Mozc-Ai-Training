...
def validate_record(record: Any) -> list[str]:
    ...
    if candidates and record["gold"] not in {c["surface"] for c in candidates if isinstance(c, dict) and "surface" in c}:
...
__all__ = ["FORMAT_VERSION", "SCHEMA_VERSION", "validate_candidate", "validate_record", "is_valid_record"]
